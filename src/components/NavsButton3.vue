      ...
      <div class="navigation-links">
        <transition-group name="fade">
          ...
          <div v-show="showLink" key="2">
            <router-link to="/costentry"
              ><i class="fas fa-money-check-alt"></i> Add Costs</router-link
            >
          </div>
          <div v-if="admin" v-show="showLink" key="3">
            <router-link id="active" to="/statistic"
              ><i id="active" class="fas fa-chart-pie"></i>
              Statistic</router-link
            >
          </div>
        </transition-group>
      </div>
